                        ...
                        <div class="row mb-2">
                            <div class="col-sm-12">
                                <div class="float-sm-right">
                                    <a href="add.php" class="btn btn-primary">Ajouter un équipe</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="input-group" style="width:auto;">
                                ...
                                <select class="custom-select" id="projectFilter">
                                    ...
                                    <option value="projet3">CNMH</option>
                                    <option value="projet3">LMS</option>
                                    <option value="projet2">E-Commerce</option>
                                </select>
                            </div>
