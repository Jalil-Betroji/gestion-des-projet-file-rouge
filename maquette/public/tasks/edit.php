                            ...
                            <div class="card card-primary">
                                ...
                                <form>
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Issues</label>
                                            <select name="nom" id="Issues" class="form-control" multiple>
                                                <option
                                                    value="gestion de rendez-vous / recherche sa marche pas bug new_issue">
                                                    gestion de rendez-vous / recherche sa marche pas bug new_issue
                                                </option>
                                                <option value="gestion consultation / la date de consultation doit etre siasie
                                                automatique en utilisant le time zone bug new_issue">gestion
                                                    consultation / la date de consultation doit etre siasie
                                                    automatique en utilisant le time zone bug new_issue</option>
                                                <option
                                                    value="changer le titre de routage choix/tuteur en choix-tuteur bug new_issue">
                                                    changer le titre de routage choix/tuteur en choix-tuteur bug
                                                    new_issue</option>
                                                <option
                                                    value="Gestions rendez-vous/Ajouter/le champ doit avoir la date automatique bug">
                                                    Gestions rendez-vous/Ajouter/le champ doit avoir la date automatique
                                                    bug</option>
                                                <option
                                                    value="Authorisation de supprimer en consultation-medecin-generale">
                                                    Authorisation de supprimer en consultation-medecin-generale</option>
                                            </select>
                                        </div>
