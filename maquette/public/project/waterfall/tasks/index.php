                    ...
                    <div class="card-header d-flex">
                        ...
                        <div class="input-group w-25  mr-2">
                            ...
                            <select class="custom-select" id="projectFilter">
                                <option selected disabled>Filtrer par phase</option>
                                <option value="projet3">Tous les phases</option>
                                <option value="Requirements Analysis">Requirements Analysis</option>
                                <option value="Design">Design</option>
                                <option value="Implementation">Implementation</option>
                                <option value="Testing">Testing</option>
                                <option value="Integration">Integration</option>
                                <option value="Maintenance and Evolution">Maintenance and Evolution</option>
                            </select>
                        </div>
