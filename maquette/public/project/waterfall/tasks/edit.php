                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" id="projectFilter">
                                                <option value="projet3" selected>Projet 1</option>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Pahse</label>
                                            <select name="nom" id="projectPhase" class="form-control">
                                                <option value="Requirements Analysis" selected>Requirements Analysis
                                                </option>
                                                <option value="Design">Design</option>
                                                <option value="Implementation">Implementation</option>
                                                <option value="Testing">Testing</option>
                                                <option value="Integration">Integration</option>
                                                <option value="Maintenance and Evolution">Maintenance and Evolution
                                                </option>
                                            </select>
                                        </div>
